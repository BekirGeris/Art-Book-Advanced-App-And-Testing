...
class ArtRecyclerAdapter @Inject constructor(
    ...
    override fun onBindViewHolder(holder: ArtViewHolder, position: Int) {
        ...
        val nameText = holder.itemView.findViewById<TextView>(R.id.art_row_name_txt)
        val artistNameText = holder.itemView.findViewById<TextView>(R.id.art_row_artist_name_txt)
        val yearText = holder.itemView.findViewById<TextView>(R.id.art_row_year_txt)
